...
public class UserInput {
    public static void main(String[] args) {
        ...
        // Creating a Scanner object from the imported Scanner class to read input from the keyboard
        ...
        name = scanner.next(); // reads a string until the first space, while .nextLine() reads the entire line including spaces
        ...
        System.out.println("Student status: " + (isStudent ? "Student" : "Not a Student")); // Using a ternary operator to display student status or shorthand for boolean output
        ...
        /* Take note:
            ...
            * left in the input buffer. Otherwise, the next call to nextLine() will read that 
            * leftover newline and skip user input.
            * 
            * This issue occurs with next(), nextInt(), nextDouble(), etc., because they do not 
            * consume the newline after pressing Enter. To avoid this, call scanner.nextLine() 
