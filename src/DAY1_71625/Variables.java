...
public class Variables {
    public static void main(String[] args) {
         ...
         * 1. Primitive types: These are the basic data types in Java. Stored directly
         * in memory (stack).
         * 2. Reference types: These are more complex types that refer to objects.
         * Stored in memory (heap).
         * * Bank vs wallet analogy: Think of the stack as a wallet where you carry a
         * small amount of cash (primitive types), and the heap as a bank where you
         * store larger amounts of money or valuable items (reference types).
         * * If I gave you a $100 bill (primitive type), you could easily fit it in your
         * wallet (stack). But if I gave you a credit card (reference type), you would
         * need to go to the bank (heap) to access your funds.
         *
         ...
         * - float: is used for single-precision floating-point numbers, useful for
         * numbers with decimal points like 1.5f, 2.3f
         * - n'f' is used to indicate a float literal because Java treats decimal
         ...
         * 2. Initialization or Assignment: Assign a value to the variable (using the
         * '=' operator).
         */
