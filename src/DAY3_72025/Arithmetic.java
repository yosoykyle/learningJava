...
public class Arithmetic 
{
    public static void main(String[] args) 
    {
        ...
        // Modulus: useful when for determining if a number is even or not or for finding the remainder or when working with cycles.
        ...
        // Augmented Assignment Operators  these operators are used to perform arithmetic operations and assign the result to the variable in a single step.
